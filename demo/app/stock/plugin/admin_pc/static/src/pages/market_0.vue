				...
				<mm_view>
					...
					<mm_body>
						...
						<div class="mm_action">
							<h5><span>操作</span></h5>
							<div class="">
								<mm_btn class="btn_primary-x" url="./market_0_form">添加</mm_btn>
						...
						<mm_table type="2">
							...
							<draggable v-model="list" tag="tbody" @change="sort_change">
								<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./market_0_form?code=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/stock/market_0",
				url_del: "/apis/stock/market_0?method=del&",
				url_set: "/apis/stock/market_0?method=set&",
				field: "code",
				query_set: {
					"code": ""
				},
