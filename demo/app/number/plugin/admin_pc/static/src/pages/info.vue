						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td><span class="th_tinyint">{{arr_private[o.private] }}</span></td>
									<td><span class="th_tinyint">{{arr_heYue[o.heYue] }}</span></td>
									<td><span class="th_tinyint">{{arr_hide[o.hide] }}</span></td>
									<td><span class="th_smallint">{{arr_kid[o.kid] }}</span></td>
									<td><span class="th_mediumint">{{ o.yid }}</span></td>
									<td><span class="th_mediumint">{{ o.tid }}</span></td>
									...
									<td><span class="th_int">{{ o.huaFei }}</span></td>
									<td><span class="th_int">{{ o.maiJia }}</span></td>
									<td><span class="th_int">{{ o.daiLiJia }}</span></td>
									<td><span class="th_int">{{ o.diJia }}</span></td>
									...
									<td><span class="th_varchar">{{ o.number }}</span></td>
									<td><span class="th_varchar">{{ o.format }}</span></td>
									<td><span class="th_varchar">{{ o.activity }}</span></td>
...
<style>
	...
	/* 筛选栏栏 */
	#number_info .mm_filter {}

	/* 操作栏 */
	#number_info .mm_action {}

	/* 模态窗 */
	#number_info .mm_modal {}

	/* 表格 */
	#number_info .mm_table {}

	/* 数据统计 */
	#number_info .mm_data_count {}
</style>
