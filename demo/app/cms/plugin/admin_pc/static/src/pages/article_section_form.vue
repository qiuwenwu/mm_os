			...
			<mm_col width="33">
				<mm_form class="card">
					...
					<dl>
						...
						<dd>
							<mm_input v-model="form.title" :minlength="0" :maxlength="0" placeholder="" :required="true"/>
						</dd>
						<dt class="required">章节标签</dt>
						<dd>
							<mm_input v-model="form.tag" :minlength="0" :maxlength="0" placeholder="" :required="true"/>
						</dd>
						<dt>章节内容</dt>
						<dd>
