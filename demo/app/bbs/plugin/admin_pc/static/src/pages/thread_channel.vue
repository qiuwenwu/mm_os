					...
					<mm_body>
						<mm_form class="mm_filter">
							...
							<mm_list col="3">
								...
								<mm_col>
									<mm_select v-model="query.father_id" title="上级" :options="$to_kv(list_thread_channel, 'channel_id', 'name')" @change="search()" />
								</mm_col>
								<mm_col>
						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
									...
									<td>
										<span>{{ get_name(list_thread_channel, o.father_id, 'channel_id', 'name') }}</span>
									</td>
									<td>
