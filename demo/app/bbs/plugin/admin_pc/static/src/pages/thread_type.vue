					...
					<mm_body>
						<mm_form class="mm_filter">
							...
							<mm_list col="3">
								...
								<mm_col>
									<mm_select v-model="query.father_id" title="上级分类" :options="$to_kv(list_thread_type, 'type_id', 'name')" @change="search()" />
								</mm_col>
								<mm_col>
						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
									...
									<td>
										<span>{{ get_name(list_thread_type, o.father_id, 'type_id', 'name') }}</span>
									</td>
									<td>
										<span>{{ o.name }}</span>
									</td>
			...
			<mm_view class="card bg_no">
				...
				<mm_body>
					<dl>
						<dt>上级分类</dt>
						<dd>
							<mm_select v-model="form.father_id" :options="$to_kv(list_thread_type, 'type_id', 'name')" />
						</dd>
					</dl>
				</mm_body>
				<footer>
