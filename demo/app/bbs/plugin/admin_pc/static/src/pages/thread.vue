					...
					<mm_body>
						<mm_form class="mm_filter">
							...
							<mm_list col="3">
								...
								<mm_col>
									<mm_select v-model="query.type_id" title="主题分类" :options="$to_kv(list_thread_type, 'type_id', 'name')"
									 @change="search()" />
								</mm_col>
								<mm_col>
									<mm_select v-model="query.channel_id" title="频道" :options="$to_kv(list_thread_channel, 'channel_id', 'name')"
									 @change="search()" />
								</mm_col>
								<mm_col>
