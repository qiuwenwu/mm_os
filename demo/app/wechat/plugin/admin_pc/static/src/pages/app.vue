				...
				<mm_view>
					...
					<mm_body>
						<mm_form class="mm_filter">
							...
							<mm_list col="3">
								<mm_col>
									<mm_input v-model="query.keyword" title="关键词" desc="应用名称" @blur="search()" />
								</mm_col>
								<mm_col>
						...
						<mm_table type="2">
							<thead>
								<tr>
									...
									<th scope="col">
										<mm_reverse title="上次使用时间" v-model="query.orderby" field="update_time" :func="search"></mm_reverse>
									</th>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/wechat/app",
				url_del: "/apis/wechat/app?method=del&",
				url_set: "/apis/wechat/app?method=set&",
				field: "app_id",
				query_set: {
					"app_id": ""
				},
