			...
			<mm_col width="33">
				<mm_form class="card">
					...
					<dl>
						...
						<dd>
							<mm_input v-model="form.type" :minlength="0" :maxlength="0" placeholder="question问答 / info资讯 / news新闻 / shop店铺 / activity活动" :required="true"/>
						</dd>
						...
						<dt>风格模板</dt>
						<dd>
							<mm_input v-model="form.template" :minlength="0" :maxlength="0" placeholder="频道和店铺都使用的样式" />
						</dd>
						<dt>频道图标</dt>
						<dd>
