				...
				<mm_view>
					...
					<mm_body>
						<mm_form class="mm_filter">
							...
							<mm_list col="3">
								<mm_col>
									<mm_input v-model="query.keyword" title="关键词" desc="标题 / 描述 / 关键词 / 标签" @blur="search()" />
								</mm_col>
								<mm_col>
								...
								<mm_col>
									<mm_select v-model="query.type_id" title="店铺分类" :options="$to_kv(list_shop_type, 'type_id', 'name')" @change="search()" />
								</mm_col>
								<mm_col>
									<mm_select v-model="query.channel_id" title="频道" :options="$to_kv(list_shop_channel, 'channel_id', 'name')" @change="search()" />
								</mm_col>
								<mm_col>
									<mm_select v-model="query.city_id" title="所属城市" :options="$to_kv(list_address_city, 'city_id', 'name')" @change="search()" />
								</mm_col>
								<mm_col>
									<mm_select v-model="query.user_id" title="店铺所属人" :options="$to_kv(list_account, 'user_id', 'nickname')" @change="search()" />
								</mm_col>
								<mm_col>
