				...
				<mm_view>
					...
					<mm_body>
						<mm_form class="mm_filter">
							...
							<mm_list col="3">
								<mm_col>
									<mm_input v-model="query.keyword" title="关键词" desc="参操函数名" @blur="search()" />
								</mm_col>
								<mm_col>
						...
						<div class="mm_action">
							<h5><span>操作</span></h5>
							<div class="">
								<mm_btn class="btn_primary-x" url="./action_log_form">添加</mm_btn>
						...
						<mm_table type="2">
							<thead>
								<tr>
									...
									<th scope="col">
										<mm_reverse title="参操函数名" v-model="query.orderby" field="func_name" :func="search"></mm_reverse>
									</th>
									<th scope="col">
										<mm_reverse title="操作者uin" v-model="query.orderby" field="uin_action" :func="search"></mm_reverse>
									</th>
									<th scope="col">
										<mm_reverse title="操作方法" v-model="query.orderby" field="method" :func="search"></mm_reverse>
									</th>
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
									...
									<td>
										<span>{{ o.func_name }}</span>
									</td>
									<td>
										<span>{{ o.uin_action }}</span>
									</td>
									<td>
										<span>{{ o.method }}</span>
									</td>
									<td>
										<mm_btn class="btn_primary" :url="'./action_log_form?action_id=' + o[field]">修改</mm_btn>
