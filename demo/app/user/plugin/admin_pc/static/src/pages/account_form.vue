			...
			<mm_col width="33">
				<mm_form class="card">
					...
					<dl>
						...
						<dd>
							<mm_input v-model="form.invite_code" :minlength="0" :maxlength="0" placeholder="随着用户注册而生成" :required="true"/>
						</dd>
						<dt>手机号码</dt>
						<dd>
						...
						<dd>
							<mm_input v-model="form.username" :minlength="0" :maxlength="0" placeholder="用户登录时所用的账户名称" :required="true"/>
						</dd>
						<dt>昵称</dt>
						<dd>
