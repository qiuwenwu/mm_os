						...
						<mm_card>
							...
							<div class="card_body">
								<mm_form class="bar_filter">
									...
									<mm_list col="3">
										<mm_item>
											<control_input v-model="query.keyword" title="关键词" desc="应用名 / 标题 / 描述 / 关键词"
											 @blur="search()" />
										</mm_item>
										<mm_item>
											<control_select v-model="query.type_id" title="应用分类" :options="$to_kv(list_app_type, 'type_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="应用分类" v-model="query.orderby" field="type_id" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="应用名" v-model="query.orderby" field="name" :func="search"></control_reverse>
											</th>
											<th>
			...
			<mm_card class="card">
				...
				<div class="card_body">
					<dl>
						<dt>应用分类</dt>
						<dd>
							<control_select v-model="form.type_id" :options="$to_kv(list_app_type, 'type_id', 'name')" />
						</dd>
					</dl>
				</div>
				<div class="card_foot">
