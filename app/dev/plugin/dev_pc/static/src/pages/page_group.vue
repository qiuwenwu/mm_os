							...
							<div class="card_body">
								<mm_form class="bar_filter">
									...
									<mm_list col="3">
										...
										<mm_item>
											<control_select v-model="query.father_id" title="上级分组" :options="$to_kv(list_page_group, 'group_id', 'name')"
											 @change="search()" />
										</mm_item>
										<mm_item>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="上级分组" v-model="query.orderby" field="father_id" :func="search"></control_reverse>
											</th>
											<th>
			...
			<mm_card class="card">
				...
				<div class="card_body">
					<dl>
						<dt>上级分组</dt>
						<dd>
							<control_select v-model="form.father_id" :options="$to_kv(list_page_group, 'group_id', 'name')" />
						</dd>
						<dt>适用的应用</dt>
						<dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/dev/page_group",
				url_del: "/apis/dev/page_group?method=del&",
				url_set: "/apis/dev/page_group?method=set&",
				url_import: "/apis/dev/page_group?method=import&",
				url_export: "/apis/dev/page_group?method=export&",
				field: "group_id",
				query_set: {
					"group_id": ""
				},
