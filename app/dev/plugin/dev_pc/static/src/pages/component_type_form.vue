							...
							<div class="card_body">
								<mm_form>
									<dl>
										<dt>上级分类</dt>
										<dd>
											<control_select v-model="form.father_id" :options="$to_kv(list_component_type, 'type_id', 'name', 0)" />
										</dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url: "/apis/dev/component_type?",
				url_get_obj: "/apis/dev/component_type?method=get_obj",
				field: "type_id",
				query: {
					"type_id": 0
				},
